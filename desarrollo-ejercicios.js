...
function EstudianteConstructor(nombre, apellidos, fechaNacimiento, id, nuevoIngreso, carrera, cursosMatriculados, cursosCursados) {
  ...
  this.cursoCursado = function(curso, nota) {
    ...
    if (nota > 70){
      ...
      this.cursosCursados.push("estado: desaprobado");
    }
  }
}
...
const nicole = new EstudianteConstructor('Nicole', 'Wallace', '1991-11-30', 'dis-0001', true, 'Diseño Gráfico', ['Teoría del Color', 'Historia del Arte II']);
nicole.cursoCursado('curso: Historia del Arte I', 80)

console.log(nicole)

const peter = new EstudianteConstructor('Peter', 'Anderson', '1992-1-30', 'dis-0001', true, 'Diseño Gráfico', ['Historia del Arte I']);
peter.cursoCursado('curso: Teoría del Color', 50)
